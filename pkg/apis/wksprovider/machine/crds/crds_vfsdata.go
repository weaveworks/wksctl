...
var CRDs = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 3, 17, 14, 16, 52, 206141281, time.UTC),
		},
		"/cluster_v1alpha1_cluster.yaml": &vfsgen۰CompressedFileInfo{
			name:             "cluster_v1alpha1_cluster.yaml",
			modTime:          time.Date(2020, 3, 17, 14, 16, 52, 205487087, time.UTC),
		...
		"/cluster_v1alpha1_machine.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 17, 14, 16, 52, 205671988, time.UTC),
		...
		"/cluster_v1alpha1_machineclass.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 17, 14, 16, 52, 205864470, time.UTC),
		...
		"/cluster_v1alpha1_machinedeployment.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 17, 14, 16, 52, 206041017, time.UTC),
		...
		"/cluster_v1alpha1_machineset.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 17, 14, 16, 52, 206200096, time.UTC),
