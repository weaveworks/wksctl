...
var CRDs = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 7, 23, 16, 45, 30, 969781371, time.UTC),
		},
		"/cluster_v1alpha1_cluster.yaml": &vfsgen۰CompressedFileInfo{
			name:             "cluster_v1alpha1_cluster.yaml",
			modTime:          time.Date(2020, 7, 23, 16, 45, 30, 969338583, time.UTC),
		...
		"/cluster_v1alpha1_machine.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 23, 16, 45, 30, 969471593, time.UTC),
		...
		"/cluster_v1alpha1_machineclass.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 23, 16, 45, 30, 969597270, time.UTC),
		...
		"/cluster_v1alpha1_machinedeployment.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 23, 16, 45, 30, 969709150, time.UTC),
		...
		"/cluster_v1alpha1_machineset.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 23, 16, 45, 30, 969833828, time.UTC),
