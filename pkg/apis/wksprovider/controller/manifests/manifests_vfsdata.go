...
var Manifests = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 3, 30, 21, 35, 37, 304496684, time.UTC),
		},
		...
		"/05_sealed_secret_crd.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 30, 21, 35, 37, 304400589, time.UTC),
		...
		"/06_sealed_secret_controller.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 3, 30, 21, 35, 37, 304680685, time.UTC),
