...
var Manifests = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 4, 28, 11, 44, 18, 474973534, time.UTC),
		},
		...
		"/05_sealed_secret_crd.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 4, 1, 17, 13, 9, 57240995, time.UTC),
		...
		"/06_sealed_secret_controller.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 4, 28, 11, 44, 18, 470973521, time.UTC),
