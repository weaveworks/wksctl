...
var Manifests = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2021, 6, 16, 2, 59, 57, 57255255, time.UTC),
		},
		"/01_namespace.yaml": &vfsgen۰FileInfo{
			name:    "01_namespace.yaml",
			modTime: time.Date(2019, 8, 22, 21, 31, 25, 627468262, time.UTC),
		...
		"/02_rbac.yaml": &vfsgen۰CompressedFileInfo{
			name:             "02_rbac.yaml",
			modTime:          time.Date(2021, 6, 16, 2, 59, 57, 57069723, time.UTC),
		...
		"/03_secrets.yaml": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2019, 8, 22, 21, 31, 25, 627652588, time.UTC),
		...
		"/04_controller.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 6, 16, 2, 59, 57, 57339584, time.UTC),
		...
		"/05_sealed_secret_crd.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 4, 8, 23, 22, 58, 85629556, time.UTC),
		...
		"/06_sealed_secret_controller.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 7, 22, 21, 5, 9, 373397079, time.UTC),
