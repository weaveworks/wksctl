...
func BuildCRIPlan(criSpec *baremetalspecv1.ContainerRuntime, cfg *envcfg.EnvSpecificConfig, pkgType resource.PkgType) plan.Resource {
	...
	case resource.PkgTypeRHEL:
		b.AddResource(
			...
			&resource.Run{
				Script:     object.String("yum install -y http://mirror.centos.org/centos/7/extras/x86_64/Packages/container-selinux-2.107-3.el7.noarch.rpm"),
				UndoScript: object.String("yum remove container-selinux")})
		b.AddResource("install:docker", &resource.RPM{Name: criSpec.Package, Version: criSpec.Version}, plan.DependOn("install:container-selinux"))
