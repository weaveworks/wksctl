...
// Machines and BYOBMachines must be in the same order
func FirstMaster(machines []*clusterv1.Machine, bl []*byobv1.BYOBMachine) (*clusterv1.Machine, *byobv1.BYOBMachine) {
...
func ParseManifest(file string) (ml []*clusterv1.Machine, bl []*byobv1.BYOBMachine, err error) {
	f, err := os.Open(file)
	if err != nil {
		return nil, nil, err
	}
...
func Parse(r io.ReadCloser) (ml []*clusterv1.Machine, bl []*byobv1.BYOBMachine, err error) {
...
func Validate(machines []*clusterv1.Machine, bl []*byobv1.BYOBMachine) field.ErrorList {
	...
	if len(machines) != len(bl) {
		errors = append(errors, nonFieldError("mismatch: %d Machines and %d BYOBMachines", len(machines), len(bl)))
	} else {
...
type InvalidMachinesHandler = func(machines []*clusterv1.Machine, bl []*byobv1.BYOBMachine, errors field.ErrorList) ([]*clusterv1.Machine, []*byobv1.BYOBMachine, error)
...
func ParseAndDefaultAndValidate(machinesManifestPath string, errorsHandler InvalidMachinesHandler) ([]*clusterv1.Machine, []*byobv1.BYOBMachine, error) {
...
func GetKubernetesVersionFromMasterIn(machines []*clusterv1.Machine, bl []*byobv1.BYOBMachine) (string, string, error) {
